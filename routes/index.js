...
{'id':40 ,'title': 'Serverless Computing ','description':  'A centralized storage location for software packages, libraries, and dependencies used in the development and deployment process, often managed with tools like Nexus or Artifactory. ',
   ...
   {'id':41 ,'title': 'SLA (Service Level Agreement) ','description':  'A formal agreement between a service provider and a customer that defines the expected level of service, including performance, uptime, and support. ',
   'reference':'B. de Best, “DevOps Plan - SLA’s and non functional requirements,” IT Strategy, Jul. 14, 2017. https://www.itpedia.nl/2017/07/14/devops-plan-slas-and-non-functional-requirements/ (accessed Sep. 24, 2023)'},


{'id':42 ,'title': 'Mean Time Between Failures (MTBF) ','description':  'he average time between failures or incidents, indicating system or component reliability. ',
   'reference':'AlertOps, “MTTD vs. MTTF vs. MTBF vs. MTTR,” Medium, Jun. 15, 2018. https://medium.com/@AlertOps/mttd-vs-mttf-vs-mtbf-vs-mttr-f5704457562c (accessed Sep. 24, 2023).'},
  

{'id':43 ,'title': 'Mean Time To Recovery (MTTR) ','description':  'he average time it takes to recover a system or service after an outage or failure. ',
   'reference':'AlertOps, “MTTD vs. MTTF vs. MTBF vs. MTTR,” Medium, Jun. 15, 2018. https://medium.com/@AlertOps/mttd-vs-mttf-vs-mtbf-vs-mttr-f5704457562c (accessed Sep. 24, 2023).'},


{'id':44 ,'title': 'Chef:','description':  'An automation platform that manages infrastructure as code, enabling automated configuration and deployment of servers ',
   'reference':'“What is Chef? Devops Tool For Configuration Management,” Intellipaat Blog, Nov. 05, 2018. https://intellipaat.com/blog/what-is-chef/'},


{'id':45 ,'title': 'Dark Launch ','description':  'A technique where new features or changes are deployed to production but kept hidden from users, allowing testing and monitoring before full release ',
   'reference':'“Dark Launch,” Split. https://www.split.io/glossary/dark-launch/#:~:text=Dark%20launching%20is%20the%20term (accessed Sep. 24, 2023).'},


{'id':46 ,'title': 'Runbook ','description':  ' documented set of procedures and instructions for handling common operational tasks, incidents, and maintenance activities. ',
   'reference':'Atlassian, “DevOps Runbook Template,” Atlassian. https://www.atlassian.com/software/confluence/templates/devops-runbook (accessed Sep. 24, 2023).'},


{'id':47 ,'title': 'Self-Healing Systems ','description':  'Systems or applications designed to automatically detect and recover from failures without human intervention. ',
   'reference':'“Self-Healing Systems in DevOps,” DEV Community, Jul. 07, 2021. https://dev.to/alexandermair/self-healing-systems-in-devops-4mfc (accessed Sep. 24, 2023).'},


{'id':48 ,'title': 'Deployment Rollforward: ','description':  'he process of applying a planned change or update to fix issues encountered during a deployment rather than rolling back to a previous version. ',
   'reference':'“Rolling Forward and other Deployment Myths - DZone,” dzone.com. https://dzone.com/articles/rolling-forward-and-other (accessed Sep. 24, 2023).'},
  


{'id':49 ,'title': 'Secret Rotation ','description':  'The practice of regularly changing and updating sensitive information, like passwords or encryption keys, to enhance security. ',
   'reference':'“Secret Rotation,” Akeyless. https://www.akeyless.io/secrets-management-glossary/secret-rotation/ (accessed Sep. 24, 2023).'},

{'id':50 ,'title': 'Kanban ','description':  'An agile methodology that focuses on visualizing and optimizing the flow of work items through a system, often represented as a Kanban board. ',
   'reference':'“Here is How to Apply Kanban for DevOps Teams,” Kanban Software for Agile Project Management. https://kanbanize.com/blog/kanban-for-devops-teams (accessed Sep. 24, 2023).'},
